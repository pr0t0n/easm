...
BASE_URL_DEFAULT = os.getenv("SCRIPTKIDDO_BASE_URL", "http://localhost:8000").rstrip("/")
ADMIN_EMAIL_DEFAULT = os.getenv("SCRIPTKIDDO_ADMIN_EMAIL", "admin@example.com")
ADMIN_PASSWORD_DEFAULT = os.getenv("SCRIPTKIDDO_ADMIN_PASSWORD", "admin123")
TARGET_DEFAULT = os.getenv("SCRIPTKIDDO_TARGET", "example.com")
TIMEOUT_SECONDS_DEFAULT = int(os.getenv("SCRIPTKIDDO_E2E_TIMEOUT", "180"))
