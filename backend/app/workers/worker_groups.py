...
CANONICAL_GROUP_TOOLS: dict[str, list[str]] = {
    ...
    "exploitation": ["nuclei", "sqlmap", "dalfox", "wapiti", "wpscan", "nikto", "interactsh-client", "katana", "arjun", "curl-headers"],
...
CANONICAL_GROUP_MISSIONS: dict[str, dict[str, Any]] = {
    ...
    "delivery": {
        "mission": "Descobrir caminhos, arquivos, vhosts e parametros que alimentam validacoes de vulnerabilidade, usando wordlists Kali/Seclists rastreaveis.",
        "phases": ["P04", "P15", "P16"],
        "techniques": ["ffuf Seclists directory fuzzing", "ffuf Seclists file fuzzing", "content discovery", "parameter mining", "API surface expansion"],
    ...
    "exploitation": {
        ...
        "techniques": ["template validation", "SQLi validation", "XSS validation", "SSRF/OOB validation", "API abuse", "IDOR/BOLA two-account reproduction"],
    ...
    "installation": {
        ...
        "phases": ["P14", "P19"],
        "techniques": ["Hydra -L/-P controlled brute-force", "JWT analysis", "auth bypass checks", "role/tenant validation", "IDOR authorization delta"],
        "evidence_focus": ["account precondition", "user/pass list path", "token claim", "rate limit", "authorization delta"],
