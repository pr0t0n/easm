    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0B0F14] px-4 py-8">
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-7xl items-center gap-8 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <section className="panel relative overflow-hidden p-6 lg:p-8">
          ...
          <p className="text-xs uppercase tracking-[0.2em] text-[#9CA3AF]">Acesso corporativo</p>
          <h2 className="mt-3 font-display text-3xl font-semibold text-[#F9FAFB]">Entrar na operacao</h2>
          ...
          <form onSubmit={submit} className="mt-6 space-y-3">
            <input
              className="w-full rounded-xl border px-4 py-3 text-[#F9FAFB] outline-none"
          ...
          <div className="mt-6 rounded-xl border border-[#374151] bg-[#111827] p-4 text-sm text-[#9CA3AF]">
            <p className="font-semibold text-[#F9FAFB]">Fluxo recomendado</p>
