...
const ICONS = {
  ...
  strategy:    svg(<><path d="M4 19V5" /><path d="M4 7h11l-2 3 2 3H4" /><path d="M18 19v-7" /><path d="m15 15 3-3 3 3" /></>),
...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    itens: [
      ...
      { to: "/estrategia",   label: "Estratégia",    icon: "strategy",   adminOnly: true },
      {
        to: "/configuracoes",
        label: "Configurações",
        icon: "settings",
